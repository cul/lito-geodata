...
# omniauth-cul provides :columbia_cas for CAS login. Read its user/session
# wiring in Users::OmniauthCallbacksController - see
# app/controllers/users/omniauth_callbacks_controller.rb. The gem also
# offers a :developer_uid strategy (a dev-only "type in a uid" form), but
