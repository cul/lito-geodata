...
# gem "solid_cache"   # not needed — geodata has no fragment caching requirements
# gem "solid_queue"   # not needed — geodata has no background job processing
# gem "solid_cable"   # not needed — geodata has no Action Cable/WebSocket features
